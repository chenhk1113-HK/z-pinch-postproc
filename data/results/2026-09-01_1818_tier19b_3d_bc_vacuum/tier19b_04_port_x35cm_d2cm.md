...
## Diagnostic ports
  ...
  - Port 0: at (x=35.0, y=0.0) cm, radius=1.00 cm (diameter=2.00 cm)

## Headline TBR

| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9030 ± 0.0045** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9030 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -34.00 cm |
| Peak TBR value | 4.8117e-03 |
...
|---|---|---|---|
| TBR_total | 0.9030 ± 0.0045 | 1.8306 ± 0.0076 | **-50.67%** |
...
|---|---|---|
| Be multiplier ring (r = 4.0–6.0 cm) | 0.0459 | 5.1% |
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6373** | **70.6%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1520 | 16.8% |

## Runtime & reproducibility

- **Wall-clock runtime**: 11.8 s
