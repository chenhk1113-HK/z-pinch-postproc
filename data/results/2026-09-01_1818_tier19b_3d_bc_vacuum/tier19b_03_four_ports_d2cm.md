...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9010 ± 0.0045** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9010 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -34.00 cm |
| Peak TBR value | 4.8076e-03 |
...
|---|---|---|---|
| TBR_total | 0.9010 ± 0.0045 | 1.8306 ± 0.0076 | **-50.78%** |
...
|---|---|---|
| Be multiplier ring (r = 4.0–6.0 cm) | 0.0458 | 5.1% |
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6366** | **70.7%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1513 | 16.8% |
