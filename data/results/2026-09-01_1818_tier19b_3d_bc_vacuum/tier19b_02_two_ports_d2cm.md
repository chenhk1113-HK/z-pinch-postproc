...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9031 ± 0.0042** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9031 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -34.00 cm |
| Peak TBR value | 4.8109e-03 |
...
|---|---|---|---|
| TBR_total | 0.9031 ± 0.0042 | 1.8306 ± 0.0076 | **-50.67%** |
