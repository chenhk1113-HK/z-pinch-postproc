...
|---|---|---|---|
| TBR_total | 0.9023 ± 0.0039 | 1.8306 ± 0.0076 | **-50.71%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6366** | **70.5%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1523 | 16.9% |
