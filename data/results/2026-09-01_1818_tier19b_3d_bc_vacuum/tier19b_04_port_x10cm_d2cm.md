...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9061 ± 0.0050** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9061 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -34.00 cm |
| Peak TBR value | 4.6910e-03 |
...
|---|---|---|---|
| TBR_total | 0.9061 ± 0.0050 | 1.8306 ± 0.0076 | **-50.50%** |
...
|---|---|---|
| Be multiplier ring (r = 4.0–6.0 cm) | 0.0464 | 5.1% |
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6396** | **70.6%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1524 | 16.8% |
