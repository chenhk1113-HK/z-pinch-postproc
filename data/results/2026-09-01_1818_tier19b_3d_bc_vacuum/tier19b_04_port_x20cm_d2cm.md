...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9045 ± 0.0039** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9045 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -34.00 cm |
| Peak TBR value | 4.8035e-03 |
...
|---|---|---|---|
| TBR_total | 0.9045 ± 0.0039 | 1.8306 ± 0.0076 | **-50.59%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6379** | **70.5%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1526 | 16.9% |
