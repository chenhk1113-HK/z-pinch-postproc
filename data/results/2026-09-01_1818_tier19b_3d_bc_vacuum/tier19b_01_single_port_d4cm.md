...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9017 ± 0.0040** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9017 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -34.00 cm |
| Peak TBR value | 4.7867e-03 |
...
|---|---|---|---|
| TBR_total | 0.9017 ± 0.0040 | 1.8306 ± 0.0076 | **-50.74%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6365** | **70.6%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1519 | 16.8% |
