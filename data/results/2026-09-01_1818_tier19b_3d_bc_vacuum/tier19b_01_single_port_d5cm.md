...
## Diagnostic ports
  ...
  - Port 0: at (x=20.0, y=0.0) cm, radius=2.50 cm (diameter=5.00 cm)

## Headline TBR

| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **0.9023 ± 0.0030** |
| TBR_3d_sum (mesh sum, sanity check) | 0.9023 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 57.00 cm, z = -26.00 cm |
| Peak TBR value | 4.7950e-03 |
...
|---|---|---|---|
| TBR_total | 0.9023 ± 0.0030 | 1.8306 ± 0.0076 | **-50.71%** |
...
|---|---|---|
| Be multiplier ring (r = 4.0–6.0 cm) | 0.0457 | 5.1% |
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **0.6370** | **70.6%** |
| Structure + outside (r ≥ 50.0 cm) | 0.1520 | 16.8% |

## Runtime & reproducibility

- **Wall-clock runtime**: 11.6 s
