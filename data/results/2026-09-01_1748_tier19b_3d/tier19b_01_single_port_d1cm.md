...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8314 ± 0.0087** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8314 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 15.00 cm, z = 14.00 cm |
| Peak TBR value | 9.1414e-03 |
...
|---|---|---|---|
| TBR_total | 1.8314 ± 0.0087 | 1.8306 ± 0.0076 | **+0.05%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4086** | **76.9%** |
| Structure + outside (r ≥ 50.0 cm) | 0.2642 | 14.4% |
