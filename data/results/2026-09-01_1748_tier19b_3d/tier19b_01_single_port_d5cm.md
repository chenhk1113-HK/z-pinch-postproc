...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8363 ± 0.0054** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8363 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 43.00 cm, z = 14.00 cm |
| Peak TBR value | 9.2188e-03 |
...
|---|---|---|---|
| TBR_total | 1.8363 ± 0.0054 | 1.8306 ± 0.0076 | **+0.31%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4134** | **77.0%** |
| Structure + outside (r ≥ 50.0 cm) | 0.2641 | 14.4% |
