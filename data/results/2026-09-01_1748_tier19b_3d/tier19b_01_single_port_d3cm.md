...
## Diagnostic ports
  ...
  - Port 0: at (x=20.0, y=0.0) cm, radius=1.50 cm (diameter=3.00 cm)

## Headline TBR

| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8356 ± 0.0057** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8356 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 15.00 cm, z = 14.00 cm |
| Peak TBR value | 9.1667e-03 |
...
|---|---|---|---|
| TBR_total | 1.8356 ± 0.0057 | 1.8306 ± 0.0076 | **+0.27%** |
...
|---|---|---|
| Be multiplier ring (r = 4.0–6.0 cm) | 0.0553 | 3.0% |
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4115** | **76.9%** |
| Structure + outside (r ≥ 50.0 cm) | 0.2650 | 14.4% |
