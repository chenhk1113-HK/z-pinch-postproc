...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8329 ± 0.0065** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8329 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 43.00 cm, z = 14.00 cm |
| Peak TBR value | 9.1413e-03 |
...
|---|---|---|---|
| TBR_total | 1.8329 ± 0.0065 | 1.8306 ± 0.0076 | **+0.13%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4095** | **76.9%** |
| Structure + outside (r ≥ 50.0 cm) | 0.2643 | 14.4% |

## Runtime & reproducibility

- **Wall-clock runtime**: 20.8 s
