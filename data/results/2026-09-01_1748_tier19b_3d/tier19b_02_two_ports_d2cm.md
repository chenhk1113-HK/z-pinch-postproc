...
## Diagnostic ports
  ...
  - Port 1: at (x=-20.0, y=0.0) cm, radius=1.00 cm (diameter=2.00 cm)

## Headline TBR

| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8349 ± 0.0065** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8349 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 15.00 cm, z = 14.00 cm |
| Peak TBR value | 9.1855e-03 |
...
|---|---|---|---|
| TBR_total | 1.8349 ± 0.0065 | 1.8306 ± 0.0076 | **+0.24%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4119** | **76.9%** |
| Structure + outside (r ≥ 50.0 cm) | 0.2643 | 14.4% |

## Runtime & reproducibility

- **Wall-clock runtime**: 21.1 s
