...
## Diagnostic ports
  ...
  - Port 0: at (x=20.0, y=0.0) cm, radius=1.00 cm (diameter=2.00 cm)
  - Port 1: at (x=0.0, y=20.0) cm, radius=1.00 cm (diameter=2.00 cm)
  - Port 2: at (x=-20.0, y=0.0) cm, radius=1.00 cm (diameter=2.00 cm)
  - Port 3: at (x=0.0, y=-20.0) cm, radius=1.00 cm (diameter=2.00 cm)

## Headline TBR

| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8322 ± 0.0074** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8322 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 47.00 cm, z = 14.00 cm |
| Peak TBR value | 9.1605e-03 |
...
|---|---|---|---|
| TBR_total | 1.8322 ± 0.0074 | 1.8306 ± 0.0076 | **+0.09%** |
...
|---|---|---|
| Be multiplier ring (r = 4.0–6.0 cm) | 0.0550 | 3.0% |
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4116** | **77.0%** |
| Structure + outside (r ≥ 50.0 cm) | 0.2626 | 14.3% |
