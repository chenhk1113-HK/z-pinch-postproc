...
| Quantity | Value |
|---|---|
| **TBR_total** (cell tally, sum over nuclides) | **1.8307 ± 0.0074** |
| TBR_3d_sum (mesh sum, sanity check) | 1.8307 |
| **Match ratio (mesh sum / cell tally)** | **1.0000** |
| Peak TBR location | r = 43.00 cm, z = 14.00 cm |
| Peak TBR value | 9.1271e-03 |
...
|---|---|---|---|
| TBR_total | 1.8307 ± 0.0074 | 1.8306 ± 0.0076 | **+0.01%** |
...
| **LiPb blanket ring (r = 6.0–50.0 cm)** | **1.4084** | **76.9%** |
